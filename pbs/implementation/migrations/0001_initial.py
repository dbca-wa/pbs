    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desirable_season', models.PositiveSmallIntegerField(blank=True, choices=[(8, 'Annual')], max_length=64, null=True, verbose_name='Desirable Season')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('path', models.FileField(storage=django.core.files.storage.FileSystemStorage(base_url='/static/pbs/traffic-control-diagrams/', location='/data/data/projects/pbs/staticfiles/pbs/traffic-control-diagrams'), upload_to='.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, related_name='implementation_way_created', to=settings.AUTH_USER_MODEL)),
                ('modifier', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, related_name='implementation_way_modified', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },

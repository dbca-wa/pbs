...
{
\pdfminorversion=7
\typeout{Including PDF:{{ document.document.path }} with dimensions {{document.dimensions.width}} {{document.dimensions.height}} }
% \pdfpagewidth={{document.dimensions.width}}
% \pdfpageheight={{document.dimensions.height}}
\fancyhf{}
...
\includepdf[pages=-,
scale=1,fitpaper=true,
% templatesize={\pdfpagewidth}{\pdfpageheight},
pagecommand={
% % \includepdf[pages=-, 
% % pagecommand={
...
{% else %}
\typeout{WARNING: Skipping missing file: {{ document.document.path }}}
\begin{center}
  \textcolor{red}{\textbf{[Document not available: {{ document.filename|texify|safe }}]}}
\end{center}
{% endif %}

...
\hline
\textbf{Endorsed by {{ prescription.prescribing_officer.get_full_name|texify|safe }}} & {% if prescription.prescribing_officer.get_full_name %}\textbf{ {{ prescription.modified }} } {% endif %} \\
\hline
\end{tabu}
\newline
\newline

...
{{ road.name|texify|safe }} & {{ road.road_type|texify|safe }} & {{ road.traffic_considerations|texify|safe }} & {{ road.traffic_diagram|texify|safe }} & {{ road.signs_installed|default:"" }} & {{ road.signs_removed|default:"" }} \\
\hline
{% endfor %}
\end{longtabu}
{% else %}

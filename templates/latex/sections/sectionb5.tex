...
{\small}{Sequence }                        & {{ ls.seqno }} \\*
{\small}{Strategies}                        & {{ ls.strategies|texify|safe }} \\*
{\small}{Fuel Description}                  & {{ ls.fuel_description|texify|safe }} \\*
{\small}{Fuel Age (years)}                  & {% if ls.fuel_age %}{{ ls.fuel_age }}{% else %}Unknown{% endif %} \\*
{\small}{Planned Core Ignition Type}        & {% if ls.ignition_types.all %}{{ ls.ignition_types.all|join:", " }}{% else %}No ignition types{% endif %} \\*
{\small}{Preferred FFDI}                    & {{ ls.ffdi }} \\*
{\small}{Preferred ROS Range}               & {{ ls.ros }} \\*
{\small}{Preferred Wind Speed Range (km/h)} & {{ ls.wind_speed }} \\*
{\small}{Preferred Wind Direction}          & {{ ls.wind_dir }} \\*
{\small}{Specialist Resources Required}     & {{ ls.resources|texify }} \\*
\hline
{% endfor %}
\end{longtable}
{% else %}
